...
| 🎯 | **Viewpoints** | Saved, criteria-based ways of looking at the model — table/matrix/diagram/exploration, applied to existing diagrams or executed ad hoc, including the ArchiMate Appendix-C example viewpoints |
