...
EXPECTED_ENTITY_TYPES = {
    ...
    "archimate-implementation": ("deliverable", "plateau", "work-package"),
    "archimate-layered": (
        "and-junction",
        "application-component",
        "application-interface",
    ...
    "bowtie": (),
    "c4-component": ("application-component", "business-actor", "data-object", "function", "role", "service"),
    "c4-container": ("application-component", "business-actor", "data-object", "role", "service"),
    "c4-system-context": ("application-component", "business-actor", "role", "service"),
    "control-structure": (),
    "datatype": (),
    "gsn": (),
    "matrix": (
