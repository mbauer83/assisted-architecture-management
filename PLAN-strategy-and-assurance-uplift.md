...
- **I-E2 (amended — see PLAN-docs-rework.md §3.0):** ENG-ARCH-REPO's assurance
  ...
  containing *synthetically augmented* findings show a visible "Synthetic
  documentation data" marker; content from any non-self-model or above-WHITE store is
  never captured; production code contains **no documentation bypass**.
