---
name: vp-heuristic-reviewer-a
description: Blind heuristic-evaluation pass A (frontier-class) for the viewpoint usability stress test — one of two independent expert passes; spawn with only the surface list and severity anchors, never with prior findings.
model: fable
effort: high
