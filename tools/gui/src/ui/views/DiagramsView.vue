...
const selectType = (key: string) => {
  ...
  router.replace({ path: basePath.value, query: key ? { type: key } : {} })
  load()
}
...
<template>
  <div>
    <div class="page-header">
      ...
      <RouterLink v-if="!isGlobal" to="/diagram/create" class="create-btn">+ Create Diagram</RouterLink>
    </div>

    <template v-if="isGlobal">
      <p class="state-msg">No diagrams in the global repository yet.</p>
    </template>
    <template v-else>
