...
def artifact_save_changes(
    *,
    ...
    from src.tools.gui_routers.state import maybe_engagement_root, maybe_enterprise_root
...
def artifact_submit_for_review() -> dict[str, object]:
    ...
    """
    from src.tools import enterprise_git_ops
    from src.tools.enterprise_sync_state import load as load_state
    from src.tools.gui_routers.state import maybe_enterprise_root
