...
def execute_promotion(
    ...
    *,
    ...
    from src.common.artifact_query import ArtifactRepository as _MR
    ...
    try:
        ...
        ent_verifier = ArtifactVerifier(ent_registry)
...
def _replace_engagement_entity_with_grf(
    ...
    grf_result = ensure_global_entity_reference(
        ...
        verifier=ArtifactVerifier(None),  # minimal verifier — no registry needed here
