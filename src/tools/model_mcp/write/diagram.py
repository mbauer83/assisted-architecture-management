...
from src.tools.model_mcp.write._common import (
    ...
    model_write_ops, registry_cached, resolve_repo_roots, roots_key, verifier_for, RepoPreset,
)
...
def register(mcp: FastMCP) -> None:
    ...
    mcp.tool(
        ...
        description=(
            ...
            "Read each entity with model_query_read_artifact(mode='full') to get display_alias. "
