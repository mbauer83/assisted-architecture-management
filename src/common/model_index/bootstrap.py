...
from src.common.model_query_types import RepoMount, infer_mount
...
def get_shared_index(factory: type["ModelIndex"], repo_root: Path | list[Path] | list[RepoMount]) -> "ModelIndex":
