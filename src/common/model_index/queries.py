...
def find_connection_ids_for(index: "ModelIndex", entity_id: str, *, direction: str = "any", conn_type: str | None = None) -> list[str]:
...
def find_neighbors(index: "ModelIndex", entity_id: str, *, max_hops: int = 1, conn_type: str | None = None) -> dict[str, set[str]]:
    index._ensure_loaded()
    if max_hops < 1:
        return {}
